# Fullstack Project Structure Reference
...
backend/
├── app/
│   ├── api/v1/endpoints/   # HTTP 路由（无业务逻辑）
│   ├── core/               # 配置、数据库连接、安全
...
| `schemas/` | 定义数据结构 | 仅 Pydantic 模型，无方法 |
| `models/` | 数据库表映射 | 仅 ORM 声明，无业务方法 |
